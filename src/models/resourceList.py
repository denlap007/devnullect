...
class ResourceList(MyBaseModel):
    ...
    resource_id = ForeignKeyField(
        Resource, db_column='resource_id', related_name='resources', to_field='id')
    list_id = ForeignKeyField(
        List, db_column='list_id', related_name='lists', to_field='id')
